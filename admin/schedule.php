            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title align-self-center">Class schedule</h3>
                        <a href="#" class="btn btn-info float-right" data-toggle="modal" data-target="#addClassScheduleModal">Add Class Schedule</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
...
<!-- Add Class Schedule Modal End -->
<div class="modal fade" id="addClassScheduleModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title text-light">Add New Class Schedule</h4>
                <button type="button" class="close text-light" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form action="#" method="post" id="addclassschedule_form" class="px-3">
                    ...
                    <div class="form-group">
                        <input type="submit" name="addclassschecdule" id="addclassschedule_btn" value="Add Class Schedule" class="btn btn-success btn-block btn-lg">
                    </div>
                </form>
            </div>
        </div>
...
<!-- Class Schedule Modal End -->
<!-- Show Exam Details Modal -->
<div class="modal fade" id="showclassSchedule">
    <div class="modal-dialog modal-dialog-centered mw-100 w-50">
        <div class="modal-content">
            <div class="modal-header border-info bg-info text-white">
                <h4 class="modal-title" id="getclassScheduleTitle"></h4>
            ...
            <div class="modal-body">
                <div class="card-deck">
                    <div class="card border-primary">
                        <div class="card-body">
                            <h4 id="getclassScheduleBodyTitle"></h4>
                            <hr>
                            <p id="getclassScheduleBody"></p>
                            <strong id="getclassScheduleDate"></strong><br>
                            <strong id="getclassScheduleStartTime"></strong><br>
                            <strong id="getclassScheduleEndTime"></strong>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Edit Exam Modal -->
<div class="modal fade" id="editclassScheduleModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title text-light">Edit class Schedule</h4>
                <button type="button" class="close text-light" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form action="#" method="post" id="editclassSchedule_form" class="px-3">
                    <input type="hidden" id="classSchedule_id" name="id" value="">
                    <div class="form-group">
                        <label for="class">Class <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        <input type="submit" name="updateclassSchedule" id="updateclassSchedule_btn" value="Update classSchedule" class="btn btn-success btn-block btn-lg">
                    </div>
                </form>
            </div>
        </div>
